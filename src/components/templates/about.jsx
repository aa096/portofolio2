          ...
          <div className="bg-white rounded-xl flex place-items-center z-50 flex-col p-10 mt-[160px] sm:mt-[200px] md:mt-[240px] sl:mt-[280px] lg:ml-[450px] lg:mt-[100px] xl:ml-[550px] xl:mt-[120px] text-secondary max-w-[1200px] w-full">
            <div className="flex flex-row justify-center group">
              <img
                ...
                className="w-[150px] h-[150px] object-cover transform transition-transform rounded-full duration-300 ease-in-out group-hover:scale-105"
              />
            </div>
            <div className="flex flex-col justify-center items-center lg:p-10 xl:px-32">
              <h2 className="font-barlow font-bold text-[24px] lg:text-[36px]">Aashild R. Lauvland </
              h2>
